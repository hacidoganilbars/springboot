...
public class UsecustomquerymongodbApplication implements CommandLineRunner {

	@Autowired
	IProductRepository productRepository;

	public static void main(String[] args) {
		SpringApplication.run(UsecustomquerymongodbApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		for (Product product : productRepository.between(20, 50)) {
			System.out.println("===========================================");
