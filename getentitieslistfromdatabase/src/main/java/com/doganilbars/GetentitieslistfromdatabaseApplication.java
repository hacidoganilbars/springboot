...
public class GetentitieslistfromdatabaseApplication implements CommandLineRunner {

	@Autowired
	private IProductRepository productRepository;

	public static void main(String[] args) {
		SpringApplication.run(GetentitieslistfromdatabaseApplication.class, args);
	}
